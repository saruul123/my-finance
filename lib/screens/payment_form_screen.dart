...
class PaymentFormScreen extends StatefulWidget {
  ...
  const PaymentFormScreen({super.key, required this.loanId, this.payment});
      ...
      builder: (context, settingsProvider, child) {
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              TextButton(onPressed: _savePayment, child: Text(l10n.save)),
            ],
          ),
          body: _loan == null
              ? Center(child: Text(l10n.loanNotFound))
              : Form(
                  key: _formKey,
                  child: Padding(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${l10n.remainingBalance}: ${settingsProvider.formatAmount(_loan!.remainingBalance)}',
                                ),
                                Text(
                                  '${l10n.monthlyPayment}: ${settingsProvider.formatAmount(_loan!.monthlyPayment)}',
                                ),
                              ],
                            ),
                          ),
